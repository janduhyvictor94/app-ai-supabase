...
export default function App() {
  ...
  const handleManualSave = async () => {
    ...
    const dataToSave = { plots, products, activities, harvests, availableActivityTypes, availableCategories };
            ...
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-3 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <button title="Exportar CSV" onClick={() => {
                        ...
                        exportToCSV(dataToExport, ['Data', 'Talhão', 'Tipo', 'Descrição', 'Status', 'Custo M.O.', 'Custo Total'], 'atividades.csv');
                    ...
                    <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto items-end">
                        ...
                        <button 
                            onClick={() => {
                                ...
                                exportToCSV(dataToExport, ['Data', 'Talhão', 'Cultura', 'Classificação', 'Qtd', 'Unidade', 'Preço Unit.', 'Receita Total'], 'colheitas.csv');
                            }}
